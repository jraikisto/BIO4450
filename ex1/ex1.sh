...
mkdir ex1
cd ex1
fastqc /student_data/BIO4450/data/ex1/tumor.fastq.gz -o ./
...
java -jar /opt/binf/apps/VarScan-2.3.9/VarScan.jar mpileup2snp tumor.pileup -output-vcf 1 > tumor_snps.vcf
